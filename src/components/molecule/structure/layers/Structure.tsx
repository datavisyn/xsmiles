...
function areEqual(prevProps: Props, nextProps: Props) {
  ...
  if (prevProps.drawerConfig.drawerType !== nextProps.drawerConfig.drawerType) return false;
  if (prevProps.drawerConfig.drawerType !== nextProps.drawerConfig.drawerType) return false;
  if (prevProps.drawerConfig.method !== nextProps.drawerConfig.method) return false;
  if (prevProps.drawerConfig.structureColor !== nextProps.drawerConfig.structureColor) return false;
  if (prevProps.drawerConfig.width !== nextProps.drawerConfig.width) return false;
  if (prevProps.drawerConfig.showScoresOnStructure !== nextProps.drawerConfig.showScoresOnStructure) return false;
  if (prevProps.drawerConfig.height !== nextProps.drawerConfig.height) return false;
